...
RUN apt install -yq libc6:i386
RUN apt install -yq xvfb
#RUN apt install -yq websockify python-setuptools

# Squeak display driver
RUN apt install -yq libgl1-mesa-glx:i386 libxext6:i386 libsm6:i386 libice6:i386 libx11-6:i386
